...
> **v4.25.3+**: Plugin pages appear in the Dashboard sidebar (MDI icons) and sync Dashboard theme.
> **v4.26.0+**: Plugin page asset token fallback improved — prefer relative static paths as documented.
